...
const nam = [{
    ...
    message: ['~ এখন রাত ১১টা বাজে\nখাওয়া দাওয়া করে নেউ😙']
             ...
             {
    timer: '1:00:00 AM',
    message: ['~ এখন রাত ১২টা বাজে সবাই একটি করে ইসলামিক পোস্ট করে ঘুমিয়ে পড়ো🤟']
},
						{
    timer: '2:00:00 AM',
    message: ['~এখন রাত ১টা বাজে তাড়াতাড়ি ঘুমা ফজরের নামাজ পড়তে হবে😾']
},
						 {
    timer: '3:00:00 AM',
    message: ['~এখন রাত ২টা বাজে এখনো ঘুমাওনি সকালে ফজরের নামাজ পড়বে কে শুনি🫠।']
},
						 {
    timer: '4:00:00 AM',
    message: ['~এখন রাত ৩টা বাজে তোর আর ঘুমানো লাগবে না একটু পরে ফজরের আযান দিবে🤬।  ']
},
						 {
    timer: '5:00:00 AM',
    ...
    message: ['~এখন দুপুর ২টা বাজে সবাই দুপুরের খাবার খেয়ে নাও ☺️']
						 ...
						 {
    timer: '4:00:00 PM',
    message: ['~এখন দুপুর ৩টা বাজে ইসলামিক পোস্ট করো ❤️']
},
						{
    timer: '5:00:00 PM',
    ...
    message: ['এখন সন্ধ্যা ৭ টা বাজে কি করছো সবাই এখন এশার আযান দিবে সবাই নামাজ পড়ে নাও❤️']
             ...
             {
    timer: '9:00:00 PM',
    message: ['~এখন রাত ৮টা বাজে সবাই ইসলামিক পোস্ট করে আসো']
},
             {
    timer: '10:00:00 PM',
    message: ['এখন রাত ৯টা বাজে ইসলামিয়া ফাউন্ডেশনে মিটিং শুরু হবে ফাউন্ডেশনের সকল সদস্য মিটিংয়ে থাকবেন🥰🫶']
},
            {
    timer: '11:00:00 PM',
    message: ['~এখন রাত ১০টা বাজে ইসলামিয়া ফাউন্ডেশনে মিটিং শেষ যারা মিটিংয়ে ছিলেন না তারা অনেক গুরুত্বপূর্ণ বিষয় মিস করেছেন🥲 পরবর্তী মিটিংয়ে সবাই উপস্থিত থাকার চেষ্টা করবা 🫶🥰']
}];
