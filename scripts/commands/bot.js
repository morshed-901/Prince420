...
module.exports = {
  ...
  start: async function ({ nayan, events, args, Users }) {
    try {
      ...
      if (!msg) {
        const greetings = [
          "আহ নামাজ বেহেশতের চাবি😇😘",
          "কি এটা ইসলামিক ফাউন্ডেশন খারাপ কথা কেউ বলবা না",
          "আসো সবাই ইসলাম প্রচার করি😡",
          "অতিরিক্ত ব্যাস্ত থাকা ভালো না🥰 ব্যাস্তাতা আল্লাহ্কে ভুলিয়ে দেয়🥱",
          "ইসলামিয়া ফাউন্ডেশন সকল নিয়ম মানতে হবে😷😘",
          "আসসালামু আলাইকুম বলেন আপনার জন্য কি করতে পারি",
          "আমাকে এতো না ডেকে ইসলামিয়া ফাউন্ডেশনের Md Morshed কে ডাকেন🙄",
          "কিছু জানা থাকলে Md Morshed এর সাথে যোগাযোগ করুন",
          "সবাইকে ধন্যবাদ🥰"
        ];
